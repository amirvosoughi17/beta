...
const HeroText = () => {
  ...
  return (
    <>
      ...
      {!isLoading && (
        <div className="flex flex-col gap-7 relative z-20 mt-[30px] lg:mt-[50px] px-[13px] lg:px-6 w-full lg:max-w-[100%]">
          <div className="gap-4 px-4 flex justify-start flex-col w-full items-start">
            ...
            <motion.h1
              ...
              className="flex items-center max-w-[99%] text-neutral-400 flex-wrap lg:tracking-wide text-start sm:max-w-[80%] lg:max-w-[450px] font-medium text-[36px] leading-[60px] lg:leading-[70px] md:text-[30px] lg:text-[46px]"
            >
            ...
            <motion.p
              ...
              className="text-neutral-500 font-light text-[14.5px] lg:text-[18px] sm:max-w-[84%] max-w-[92%] text-start leading-7 tracking-wide lg:max-w-[85%] lg:leading-8"
            >
            ...
            >
              <div className="w-[100%] bg-neutral-900/80 border-[0.5px] border-neutral-600/50 backdrop-blur-md flex items-center justify-between py-[8px] rounded-xl px-2 mx-auto">
