...
const blogs = [
  ...
  {
    title: "سایت وردپرسی یا کدنویسی شده ؟",
    description:
      "اژانس دیجیتال مارکتینگ پلن با و با صولات بر محمد و ال محمداراعه خدمات مارکتینگ , سعو , تولید متحوا",
    badge: "سعو",
    href: "/blogs/seo",
    image: "/showcase.png",
  },
  {
    ...
    description:
      "طراحی ساین فروشگاهی کاره خیلی خوبیه  و باید هزینهش رو بدی به من و تحویل بگیری",
    badge: "سعو",
    href: "/blogs/seo",
    image: "/showcase.png",
  },
