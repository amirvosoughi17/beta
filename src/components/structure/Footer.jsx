...
const Footer = () => {
  return (
    <div>
      <div className="w-full h-[420px] bg-[#161D48] p-10 md:px-[100px] md:py-[100px]">
        <div className="flex flex-col gap-5">
          <div className="w-full flex items-center justify-between py-4 border-b-[0.6px] border-zinc-500">
          ...
          <div className="flex items-start justify-between px-3 pt-5">
