    ...
    <div className="mb-[450px]">
      ...
      <div className="mt-[70px] w-[94%] sm:w-[85%] lg:w-[70%] xl:w-[60%] mx-auto ">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className='border-b-0 bg-[#5D5AFF] text-white py-1.5 px-3 rounded-xl mb-3'>
          ...
          <AccordionItem value="item-2" className='border-b-0 bg-[#313036] text-white py-1.5 px-3 rounded-xl mb-3'>
          ...
          <AccordionItem value="item-3" className='border-b-0 bg-[#313036] text-white py-1.5 px-3 rounded-xl mb-3'>
